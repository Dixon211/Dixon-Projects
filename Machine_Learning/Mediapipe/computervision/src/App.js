  ...
  return (  
    <React.Fragment>
      ...
      <section id="demos" className="invisible">
        ...
        <p>Hold your hand in front of your webcam to get real-time hand landmarker detection.Click <b>enable webcam</b> below and grant access to the webcam if prompted.</p>
